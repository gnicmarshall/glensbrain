...
## What it is
New project folder, created 13 Sep 2026. **Purpose not yet defined** — the
first session that learns what this project is for must replace this
...
- Commit and push after meaningful work, like every workspace project.

## Hard rules a fresh session must not violate
- None yet. Add them here as they're decided.
